...
public class Reporter : MonoBehaviour
{
    ...
    void drawToolBar()
    {
        ...
        if (GUILayout.Button(clearContent, barStyle, GUILayout.Width(size.x * 2 * 3), GUILayout.Height(size.y * 2)))
        {
            clear();
        }
        ...
        GUILayout.BeginHorizontal((showLog) ? buttonActiveStyle : barStyle, GUILayout.Width(size.x * 2));
        if (GUILayout.Button(logContent, nonStyle, GUILayout.Width(size.x * 1), GUILayout.Height(size.y * 2)))
        {
            showLog = !showLog;
            calculateCurrentLog();
        }
        ...
        GUILayout.BeginHorizontal((showWarning) ? buttonActiveStyle : barStyle, GUILayout.Width(size.x * 2));
        if (GUILayout.Button(warningContent, nonStyle, GUILayout.Width(size.x * 1), GUILayout.Height(size.y * 2)))
        {
        ...
        GUILayout.BeginHorizontal((showError) ? buttonActiveStyle : nonStyle, GUILayout.Width(size.x * 2));
        if (GUILayout.Button(errorContent, nonStyle, GUILayout.Width(size.x * 1), GUILayout.Height(size.y * 2)))
        {
            showError = !showError;
            calculateCurrentLog();
        }
