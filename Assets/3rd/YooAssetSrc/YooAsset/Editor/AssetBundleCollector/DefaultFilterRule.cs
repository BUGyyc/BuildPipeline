...
namespace YooAsset.Editor
{
    ...
    [DisplayName("收集_Textures")]
    public class CollectTextures : IFilterRule
    {
        public bool IsCollectAsset(FilterRuleData data)
        {
            return data.AssetPath.Contains("_Textures");
        }
    }

    [DisplayName("收集__RawTex")]
    public class CollectRewTex : IFilterRule
    {
        public bool IsCollectAsset(FilterRuleData data)
        {
            return data.AssetPath.Contains("__RawTex");
        }
    }
}