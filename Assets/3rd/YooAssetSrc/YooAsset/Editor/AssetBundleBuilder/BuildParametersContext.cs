...
namespace YooAsset.Editor
{
    public class BuildParametersContext : IContextObject
    {
        ...
        public string GetPipelineOutputDirectory()
        {
            if (string.IsNullOrEmpty(_pipelineOutputDirectory))
            {
                ...
                _pipelineOutputDirectory =
                   $"{Parameters.OutputRoot}/{Parameters.PackageName}/{YooAssetSettings.OutputFolderName}";
            }
        ...
        public string GetPackageOutputDirectory()
        {
            if (string.IsNullOrEmpty(_packageOutputDirectory))
            {
                _packageOutputDirectory =
                    $"{Parameters.OutputRoot}/{Parameters.PackageName}/{VersionSettings.AssetFolderName}";
            }

            UnityEngine.Debug.Log(" _packageOutputDirectory: " + _packageOutputDirectory);
        ...
        public UnityEditor.Build.Pipeline.BundleBuildParameters GetSBPBuildParameters()
        {
            ...
            var buildParams = new UnityEditor.Build.Pipeline.BundleBuildParameters(
            ...
            if (Parameters.DisableWriteTypeTree)
                buildParams.ContentBuildFlags |= UnityEditor
                    .Build
                    .Content
                    .ContentBuildFlags
