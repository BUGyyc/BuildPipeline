...
namespace YooAsset
{
    internal class AssetSystemImpl
    {
        ...
        {
            LogMaster.Y("UnloadUnusedAssets");
        ...
        {
            LogMaster.Y("UnloadUnusedAssetsInternal");
        ...
        {
            LogMaster.Y("ForceUnloadALLAssets");
        ...
        private BundleLoaderBase CreateAssetBundleLoaderInternal(BundleInfo bundleInfo)
        {
            ...
            //if (bundleName.Contains("fonts_fonts"))
            //{

            //	LogMaster.I("load font");
            //}
