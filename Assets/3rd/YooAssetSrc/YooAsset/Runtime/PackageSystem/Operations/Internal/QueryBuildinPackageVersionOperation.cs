namespace YooAsset
{
    internal class QueryBuildinPackageVersionOperation : AsyncOperationBase
    {
        ...
        internal override void Update()
        {
            ...
            {
                LogMaster.S("[YooAssetPipeline]", " LoadBuildinPackageVersionFile");
                if (_downloader == null)
                {
                    ...
                    LogMaster.S(
                        "[YooAssetPipeline]",
                        "LoadBuildinPackageVersionFile   StreamAsset   url: " + url
                    );
                ...
                else
                {
                    ...
                    LogMaster.S(
                        "[YooAssetPipeline]",
                        " LoadBuildinPackageVersionFile , _downloader TextContent: PackageVersion "
                            + PackageVersion
                    );
