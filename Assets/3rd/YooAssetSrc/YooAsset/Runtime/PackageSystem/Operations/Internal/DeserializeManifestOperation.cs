        ...
        internal override void Update()
        {
            ...
            try
            {
                if (_steps == ESteps.DeserializeFileHeader)
                {
                    ...
                    LogMaster.S("[YooAssetPipeline]", " DeserializeFileHeader   先反序列化 清单文件的首部 ");
                ...
                {
                    LogMaster.S("[YooAssetPipeline]", " PrepareAssetList ");
                ...
                {
                    LogMaster.S("[YooAssetPipeline]", " DeserializeAssetList ");
                ...
                {
                    LogMaster.S("[YooAssetPipeline]", " PrepareBundleList ");
                ...
                if (_steps == ESteps.DeserializeBundleList)
                {
					...
					LogMaster.S("[YooAssetPipeline]", " DeserializeBundleList ");
