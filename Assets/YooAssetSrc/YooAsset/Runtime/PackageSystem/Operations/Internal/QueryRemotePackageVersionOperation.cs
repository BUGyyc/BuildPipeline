        ...
        internal override void Update()
        {
            ...
            if (_steps == ESteps.DownloadPackageVersion)
            {
                if (_downloader == null)
                {
                    ...
                    LogMaster.Log(
                        "[YooAssetPipeline]",
                        $" DownloadPackageVersion    下载   Beginning to request package version : {webURL}"
                    );
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        LogMaster.Log(
                            "[YooAssetPipeline]",
                            "   DownloadPackageVersion [PackageRuntimeData] 设定版本号，      success , RemoteVersionValue: "
                                + PackageVersion
                        );
                    }
                }
