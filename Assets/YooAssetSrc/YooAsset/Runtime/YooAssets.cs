...
namespace YooAsset
{
    public static partial class YooAssets
    {
        ...
        {
            LogMaster.S("[YooAssets]", " YooAssets.Initialize    ");
        ...
        public static void UnloadUnusedAB()
        {

            UnityEngine.Debug.Log("清理内存中不使用的 AssetBundle");

            var pack = GetPackage(VersionSettings.PackageName);
            pack.UnloadUnusedAssets();

            UnityEngine.Debug.Log("清理结束");
        }

        public static void ForceUnloadUnusedAB()
        {

            UnityEngine.Debug.Log("强制 清理内存中不使用的 AssetBundle");

            var pack = GetPackage(VersionSettings.PackageName);
            pack.ForceUnloadAllAssets();

            UnityEngine.Debug.Log("强制 清理结束");
        }
        ...
        public static ResourcePackage CreatePackage(string packageName)
        {
            ...
            YooLogger.I($"Create resource package : {packageName}");
