...
{
	public static class AssetBundleIgnoreCfg
	{

		public static List<string> IgnoreFolderList = new List<string>()
		{
			"Editor Resources/"
		};
	...
	public class AssetBundleCollector
	{
		...
		private bool IsValidateAsset(string assetPath, bool isRawFilePackRule)
		{
            ...
            // 忽略一些特殊的资源
            foreach (var item in AssetBundleIgnoreCfg.IgnoreFolderList)
            {
				if (assetPath.Contains(item))
				{
					LogMaster.BP("剔除掉忽略的 AB  " + assetPath);
					return false;
				}
            }
